...
#pragma once
#ifndef LAYERS_PLANET_LAYER_HPP
#define LAYERS_PLANET_LAYER_HPP
...
class PlanetLayer : public Widget, public ActionListener
{
  friend PlanetLayer* rPlanetLayer();
public:
